    ...
    <div class="modal-content">
      <form id="createForm" data-parsley-validate="" enctype="multipart/form-data"> 
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel">Create Office</h5>
        ...
        <div class="modal-body">
          <div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="400">
            ...
            <div class="form-group m-form__group row">
              <div class="col-md-12">
                <label>Area</label>
                <select  class="form-control m-input" name="area">
                  <?php $result=db_select_fillselect('tbl_selectmo','area');
                  for($i=1; $row = $result->fetch(); $i++){ ?>
                    <option><?=$row['area'];?></option>
                  <?php } ?>
                </select>  
              </div> 
            </div>
            <div class="form-group m-form__group row">
              <div class="col-md-12">
                <label>Code</label>
                <input type="text" name="areaCode" class="form-control m-input" placeholder="Enter Code"  />
              </div> 
            </div>
            <div class="form-group m-form__group row">
              <div class="col-md-12">
                <label>Office</label>
                <input type="text" name="office" class="form-control m-input" placeholder="Enter Office" required />
              </div> 
            </div>
...
<?php
$sql = custom_query("SELECT * FROM tbl_office ORDER BY id DESC");
if($sql->rowCount()>0) {
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
          <div class="modal-content">
            <form class="deleteForm" data-parsley-validate="">
              ...
              <div class="modal-header">
                <h5 id="exampleModalLabel">Delete Office Record</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <form class="updateForm" data-parsley-validate="" enctype="multipart/form-data"> 
            ...
            <input type="hidden" name="id" value="<?= $r['id']; ?>" />
            <div class="modal-header">
              <h5 id="exampleModalLabel">Edit Office Record</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="400">
               ...
               <div class="form-group m-form__group row">
                <div class="col-md-12">
                  <label>Area</label>
                  <input type="text" name="area" class="form-control m-input" placeholder="Enter Area" required />
                </div> 
              </div>
              <div class="form-group m-form__group row">
                <div class="col-md-12">
  ...
  <!--begin::Page Scripts --> 
  <script src="app/office.js" type="text/javascript"></script>
  <!--end::Page Scripts -->
