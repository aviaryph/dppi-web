    ...
    <div class="modal-content">
      <form id="createForm" data-parsley-validate="" enctype="multipart/form-data"> 
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel">Create User</h5>
...
<?php
$sql = custom_query("SELECT * FROM tbl_users ORDER BY id DESC");
if($sql->rowCount()>0) {
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
          <div class="modal-content">
            <form class="deleteForm" data-parsley-validate="">
              ...
              <div class="modal-header">
                <h5 id="exampleModalLabel">Delete User Record</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <form class="updateForm" data-parsley-validate="" enctype="multipart/form-data"> 
            ...
            <input type="hidden" name="id" value="<?= $r['id']; ?>" />
            <div class="modal-header">
              <h5 id="exampleModalLabel">Edit User Record</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
