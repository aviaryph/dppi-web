...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>DPPI | Web Dashboard</title>
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="application/dashboard.php" method="POST">
						...
						<div class="m-login__signup">
							...
							<form class="m-login__form m-form" action="">
								...
								<div class="m-login__form-action">
									<button id="m_login_signup_submit" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">Sign Up</button>&nbsp;&nbsp;
		...
		<!--begin::Page Scripts -->
		<script src="public/assets/snippets/custom/pages/user/login.js" type="text/javascript"></script>
